...
const maps = [
    ...
    },
    {
        ...
        walls: [
            ...
            // ÁREA 2: Rampa de descida (X: 380-420) - AJUSTADA +45px
            // Paredes que forçam descida em diagonal
            {x: 425, y: 80, w: 40, h: 150, invisible: false},  // Parede superior da rampa (movida +45px)
...
function renderFieldShadow(map) {
    if (gameState.currentMap === 0) {
        ...
        const cornerGradient4 = ctx.createRadialGradient(map.width, map.height
