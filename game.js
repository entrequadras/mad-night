    ...
    // Mapa 2 - Fronteira com o Komando Satânico (COM COLISÕES v1.26!)
    {
        ...
        buildings: [
            ...
            },
            {
                ...
                collisionRects: [
                    {x: 40, y: 1320, w: 320, h: 90}    // Retângulo único centralizado
                ]
            },
            {
                type: 'predio0003', 
                ...
                collisionRects: [
                    {x: 1460, y: 380, w: 60, h: 40},    // Meio-alto
                    {x: 1440, y: 420, w: 80, h: 40},    // Meio
                    {x: 1420, y: 460, w: 100, h: 40},   // Meio-baixo
                    {x: 1400, y: 500, w: 120, h: 40}    // Base inferior
                ]
            },
            {
                type: 'predio0008', 
                ...
                // COLISÕES: Diagonal direita-inferior para esquerda-superior
                collisionRects: [
                    {x: 381, y: 250, w: 60, h: 40},     // Meio-alto
                    {x: 361, y: 290, w: 80, h: 40},     // Meio
                    {x: 341, y: 330, w: 100, h: 40},    // Meio-baixo
                    {x: 321, y: 370, w: 120, h: 40}     // Base inferior
                ]
            },
            {
                type: 'predio0008', 
