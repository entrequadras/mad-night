// maps.js - Sistema de Mapas Consolidado

// Função helper para gerar tiles
...
const maps = [
    ...
    // Mapa 1 - Eixão da Morte
    {
        ...
        objects: [],
        walls: [
            // Túnel em formato U - todas invisíveis
            // Rampa de descida
    ...
    // Mapa 3 - Na área da KS (placeholder)
    {
        name: "Na área da KS",
        ...
        walls: [
            ...
            // Bordas
            {x: 0, y: 0, w: 600, h: 20, invisible: true},
            {x: 0, y: 780, w: 600, h: 20, invisible: true},
            {x: 0, y: 20, w: 20, h: 760, invisible: true},
            {x: 580, y: 20, w: 20, h: 760, invisible: true}
        ],
        lights: [],
        shadows: [],
    ...
    // Mapa 4 - Entre Prédios (placeholder)
    {
        name: "Entre Prédios",
    ...
    // Mapa 5 - Ninho dos Ratos (placeholder)
    {
