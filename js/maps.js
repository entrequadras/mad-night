        ...
        // Mapa 3 - Na área da KS
{
    ...
    buildings: [
        ...
        },
        {
            ...
            y: 645,
            collisionRects: [
                {x: 900, y: 856, w: 200, h: 60},
                {x: 800, y: 956, w: 220, h: 40},
                {x: 760, y: 986, w: 220, h: 40},
                {x: 650, y: 926, w: 200, h: 60}
            ]
        },
        {
            type: 'predio0002',
            ...
            y: 1950,
            collisionRects: [
                {x: 259, y: 1943, w: 180, h: 50},
                {x: 409, y: 1993, w: 200, h: 40},
                {x: 459, y: 2033, w: 200, h: 40},
                {x: 409, y: 2173, w: 180, h: 50}
            ]
        },
        {
            type: 'predio0004',
            ...
            y: 1298,
            collisionRects: [
                {x: 592, y: 1638, w: 190, h: 55},
                {x: 492, y: 1693, w: 210, h: 40},
                {x: 442, y: 1733, w: 210, h: 40},
                {x: 380, y: 1783, w: 190, h: 55}
            ]
        },
        {
            ...
            y: 230,
            collisionRects: [
                {x: 206, y: 570, w: 190, h: 55},
                {x: 256, y: 625, w: 210, h: 40},
                {x: 306, y: 665, w: 210, h: 40},
                {x: 380, y: 705, w: 190, h: 55}
            ]
        }
    ],
    trees: [
